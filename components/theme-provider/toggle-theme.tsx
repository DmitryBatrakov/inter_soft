...
export const ThemeToggle = () => {
    ...
    return (
        ...
        >
            {/* <Sun className="h-7 w-7 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-110" />
            <Moon className="absolute h-7 w-7 rotate-0 scale-100 transition-all dark:rotate-90 dark:scale-0" /> */}
