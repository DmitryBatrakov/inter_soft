...
import { items } from "@/entities/accordions/data/service-accordion-items";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-center">
                    {items.map((item) => {
                        return (
                            <Card
                                key={item.id}
                                className="px-4 py-6 lg:px-6 lg:py-6 bg-transparent backdrop-blur-2xl min-h-62.5 md:min-h-87.5 lg:min-h-125 md:max-w-150  flex flex-col justify-between group transition-all duration-300 hover:bg-primary border p-4
