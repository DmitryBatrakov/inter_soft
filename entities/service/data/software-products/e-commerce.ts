...
export const eCommerceData = {
    ...
    faq: [
        {
            question: "What is included in e-commerce store development?",
        ...
        {
            question: "Can I manage the e-commerce store myself?",
        ...
        {
            question: "Can the e-commerce store support multiple languages?",
    ...
    overview: {
        title: "E-Commerce stores that drive sales and grow your business",
        ...
        steps: [
            {
                step: "01",
                title: "Discovery",
                description: "Understanding business model and user journey",
            },
            {
                step: "02",
                title: "Design",
            ...
            },
            {
                step: "03",
                title: "Development",
                description: "Building scalable and fast online stores",
            },
            {
                step: "04",
                title: "Integrations",
